...
class ConditionalVAE(nn.Module):
    ...
    def __init__(self, latent_dim=128, num_grades=17, grade_embedding_dim=32):
        ...
        self.fc_decode = nn.Linear(latent_dim + grade_embedding_dim, self.encoder_output_size)
    ...
    def decode(self, z, grade_labels):
        ...
        x_recon = F.interpolate(x_recon, size=(18, 11), mode='bilinear', align_corners=False)
